...
public class RomanNumberTest 
{
  ...
  // String -> RomanNumber
	...
	public void Valeurs_entieres()
	{
	 ...
	 @Test(expected = IllegalArgumentException.class)
  	public void toRomanRepetition(String n) {
	...
	@Test
  	public void fromRomanToRomanValues() {
    	for(int i=1;i<4000;i++){
	assertThat(RomanNumber.fromRoman(RomanNumber.toRoman(i)),is(i));
